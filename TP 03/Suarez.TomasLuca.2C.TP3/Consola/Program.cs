        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                Alumno a2 = new Alumno(2, "Juana", "Martinez", "12234458",
                    Persona.ENacionalidad.Extranjero,
            ...
            Profesor i1 = new Profesor(1, "Juan", "Lopez",
                "12234456", Persona.ENacionalidad.Argentino);
            gim += i1;

            Profesor i2 = new Profesor(2, "Roberto", "Juarez",
                "32234456", Persona.ENacionalidad.Argentino);
            gim += i2;
            ...
            try
            {
                Console.WriteLine("AASDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD."); Console.WriteLine("AASDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD."); Console.WriteLine("AASDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD.");
                gim += Universidad.EClases.SPD;
            }
            catch (SinProfesorException e)
            {
                Console.WriteLine("AASDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD.");
                Console.WriteLine(e.Message);
            }
